          ...
          <!--card body-->
              ...
              while ($row = $result->fetch_assoc()) {
                  echo "
                      ...
                      <td><a href='shipment.php?apshpid=".$row['id']."' class='btn btn-info'>Assign Room Service</a></td>
                      </tbody>
                  ";
              }
              ?>
...
<div class="card">  
  ...
  ?>
            ...
            <div class="card-header">
            <h3 class="card-title">Assign room_service</h3>
...
if(isset($_POST['updatedriver']))
       {
        ...
        $result2=$mysqli->query("UPDATE room_service set status='allocated'  where driver_id='$did'") or die($mysqli->error);
        echo
        "<script>
        alert('success');
          ...
          <div class="card-body">
             ...
             <form role="form" method="POST">
                  <div class="class-body">
                      ...
                      $i = 0;
                      $id = array();
                      $result = $mysqli->query("SELECT * FROM room_service where status='available'");
                      if ($result === FALSE) {
                        die($mysqli->error);
                      }
