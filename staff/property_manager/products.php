        ...
        <div class="row">
          ...
          <!--card body-->
                    ...
                    <table id="example2" class="table table-bordered table-hover">
                      <thead>
                        <tr><th>PROPERTY</th><th>PROPERTY_NAME</th><th>PROPERTY_Image</th><th>Quantity</th><th>Location</th><th>Type</th><th>STATUS</th></tr>
                      </thead>
                    
                       <?php
                  $uname=$_SESSION['username']; 
                  $result=$mysqli->query("select * from products where status='pending' and property_manager_email	='$uname'  order by status")or die($mysqli->error);
...
<div class="row">
        ...
        <div class="row">
          ...
          <!--card body-->
                    ...
                    <table id="example2" class="table table-bordered table-hover">
                      <thead>
                        <tr><th>PROPERTY_ID</th><th>PROPERTY_NAME</th><th>PROPERTY_Image</th><th>QUANTITY</th><th>STATUS</th><th>ACTION</th></tr>
                      </thead>
                    
                       <?php
                       $uname=$_SESSION['username']; 
                  $result=$mysqli->query("select * from products where status='approved' and property_manager_email	='$uname' ")or die($mysqli->error);
                  while($row=$result->fetch_assoc())
                  {
                    echo
