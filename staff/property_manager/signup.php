...
if (isset($_POST['signup'])) {
    ...
    $accountStatus = 'pending'; // Assuming default status is approved
    $email = $_POST['email'];

    // Prepare and bind
    $stmt = $mysqli->prepare("INSERT INTO property_manager (firstname, lastname, gender, password, account_status, email) VALUES (?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssss", $firstName, $lastName, $gender, $password, $accountStatus, $email);
    ...
    if ($stmt->execute()) {
        ...
        echo '<script>alert("Sign-up failed: ' . $stmt->error . '");
...
<html lang="en">
<head>
    <title> Property Manager Sign Up </title>
    <meta charset="UTF-8">
        ...
        <div class="container-login100">
            <div class="wrap-login100 p-t-85 p-b-20">
                <form class="login100-form validate-form" method="POST">
                    ...
                    <!-- New Input Fields -->
                    <div class="wrap-input100 validate-input m-b-35" data-validate="Enter your first name">
                        <input class="input100" type="text" name="firstname" required>
                        <span class="focus-input100" data-placeholder="First Name"></span>
                    </div>

                    <div class="wrap-input100 validate-input m-b-35" data-validate="Enter your last name">
                        <input class="input100" type="text" name="lastname" required>
                        <span class="focus-input100" data-placeholder="Last Name"></span>
                    </div>

                    <div class="wrap-input100 validate-input m-b-35" data-validate="Select your gender">
                    ...
                    <div class="wrap-input100 validate-input m-b-35" data-validate="Enter your email">
                        <input class="input100" type="email" name="email" required>
                        <span class="focus-input100" data-placeholder="Email"></span>
                    </div>

                    <div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate="Enter your password">
                        <input class="input100" type="password" name="password" required>
                        <span class="focus-input100" data-placeholder="Password"></span>
                    </div>

                    <div class="container-login100-form-btn">
                        <input type="submit" class="login100-form-btn" name="signup" value="Sign Up" style="background-color:blue"/>
                    </div>
