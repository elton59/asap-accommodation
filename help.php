    ...
    <div class="row wow fadeIn">
      <div class="col-md-12 mb-4">
        <div class="p-4">
          ...
          <div>
            <h5>Welcome to ASAP Accomodation</h5>
            <p>Welcome to ASAP Accomodation, your premier destination for purchasing high-quality perfumes online. We strive to provide an excellent shopping experience with a wide range of fragrances to choose from. This help module will guide you through the process of registering and purchasing products on our platform.</p>

            <h5>How to Register</h5>
            <p>To register on ASAP Accomodation, follow these steps:</p>
            <ol>
            ...
            <p>Purchasing products on ASAP Accomodation is simple and secure:</p>
            <ol>
            ...
            <ul>
              <li><strong>Email:</strong> TEVIN OBIERO@gmail.com</li>
              <li><strong>Phone:</strong> 07123456789</li>
            
            </ul>

            <p>We hope this help module assists you in having a smooth and enjoyable shopping experience at ASAP Accomodation. If you have any additional questions, please do not hesitate to reach out to our support team. Thank you for choosing ASAP Accomodation!</p>
          </div>
        </div>
      </div>
    </div>
